...
if __name__ == "__main__":
    ...
    mesh_path = '$CAMOZZI_DIR_PATH/zebra_pose/data/data_object_pose/lmo/models/obj_000001.ply'
    im_width = 640
    im_height = 480
    ...
    render.icp_render.render_GT_visible_side(t, R, 0, '$CAMOZZI_DIR_PATH/zebra_pose/test_render_image.png')      
